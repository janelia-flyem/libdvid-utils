...
#ifndef DVIDPLANECONTROLLER_H
#define DVIDPLANECONTROLLER_H
...
class vtkSimpInteractor : public vtkInteractorStyleImage
{
  public:
    ...
    */
    void set_view(DVIDPlaneView* view_);
  ...
  private:
    ...
    */
    vtkSimpInteractor() : model(0), enable_selection(true) {}
...
*/
class DVIDPlaneController : public QObject, public ModelObserver {
    Q_OBJECT
  public:
    /*!
    ...
    */
    DVIDPlaneController(Model* model_, QWidget* widget_parent = 0);
